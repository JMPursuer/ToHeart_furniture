...
import com.xinzhi.furniture.mall.wx.util.WxResponseCode;
...
public class WxCartController {
     ...
     */
    @GetMapping("index")
    public Object index(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId) {
        if (userId == null) {
        ...
        for (LitemallCart cart : list) {
            ...
            LitemallGoodsProduct product = productService.findById(cart.getProductId());
            if (goods == null || !goods.getIsOnSale() || goods.getDeleted() || product == null) {
                cartService.deleteById(cart.getId());
                logger.debug("系统自动删除失效购物车商品 goodsId=" + cart.getGoodsId() + " productId=" + cart.getProductId());
            } else{
                cart.setPicUrl(product.getUrl());
                cart.setGoodsName(product.getTitle());
     ...
     */
    @PostMapping("add")
    public Object add(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, @RequestBody LitemallCart cart) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        if (cart == null) {
...
//            }
     ...
     */
    @PostMapping("fastadd")
    public Object fastadd(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, @RequestBody LitemallCart cart) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        if (cart == null) {
        ...
        if (existCart == null) {
            //取得规格的信息,判断规格库存
            if (product == null) {
                return ResponseUtil.fail(WxResponseCode.GOODS_NO_STOCK, "商品已下架");
            }
...
//            }
     ...
     */
    @PostMapping("update")
    public Object update(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, @RequestBody LitemallCart cart) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        if (cart == null) {
     ...
     */
    @PostMapping("checked")
    public Object checked(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, @RequestBody String body) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        if (body == null) {
     ...
     */
    @PostMapping("delete")
    public Object delete(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, @RequestBody String body) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        if (body == null) {
    ...
    public Object goodscount(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId) {
        if (userId == null) {
     ...
     */
    @GetMapping("checkout")
    public Object checkout(@ApiParam(name = "userId", hidden = true) @LoginUser Integer userId, Integer cartId, Integer addressId) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
