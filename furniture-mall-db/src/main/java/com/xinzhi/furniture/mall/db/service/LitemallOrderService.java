...
import com.xinzhi.furniture.mall.db.dao.LitemallOrderMapper;
import com.xinzhi.furniture.mall.db.dao.OrderMapper;
...
import com.xinzhi.furniture.mall.db.domain.LitemallOrderExample;
...
public class LitemallOrderService {
    ...
    public List<LitemallOrder> queryByOrderStatus(Integer userId, List<Short> orderStatus, Integer pageIndex, Integer pageSize) {
        LitemallOrderExample example = new LitemallOrderExample();
        example.setOrderByClause(LitemallOrder.Column.addTime.desc() + " " + Constant.LIMIT + " " + (pageIndex - 1) * pageSize + "," + pageSize);
    ...
    public long queryCountByOrderStatus(Integer userId, List<Short> orderStatus) {
        LitemallOrderExample example = new LitemallOrderExample();
        LitemallOrderExample.Criteria criteria = example.or();
        criteria.andUserIdEqualTo(userId);
        if (orderStatus != null) {
