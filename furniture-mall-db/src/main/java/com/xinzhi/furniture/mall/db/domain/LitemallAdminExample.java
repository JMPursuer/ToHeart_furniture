...
public class LitemallAdminExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value, "com.xinzhi.furniture.mall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addRoleIdsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value1, value2, "com.xinzhi.furniture.mall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
    ...
    public interface IExampleWhen {
         ...
         * @mbg.generated
         */
        void example(com.xinzhi.furniture.mall.db.domain.LitemallAdminExample example);
    }
}