...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      {
        path: 'seller',
        component: () => import('@/views/stat/seller'),
        name: 'statOrder',
        meta: {
          perms: [
            'POST /admin/performance/seller/list',
            'POST /admin/performance/seller/month/list'
          ],
          title: '业绩统计',
          noCache: true
        }
      ...
      {
        path: 'buyer',
        component: () => import('@/views/stat/buyer'),
        name: 'statOrder',
        meta: {
          perms: [
            'POST /admin/performance/buyer/list',
            'POST /admin/performance/seller/self/month/list'
          ],
          title: '业务统计',
          noCache: true
        }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          perms: [
            'POST /admin/wallet/list',
            'POST /admin/wallet/topup',
            'POST /admin/wallet/flow/list',
            'POST /admin/wallet/withdraw',
            'POST /admin/wallet/password/delete'
          ],
          title: '财务管理',
          noCache: true
        }
...

  {
    ...
    children: [
      ...
      {
        path: 'configList',
        component: () => import('@/views/goods/configList'),
        name: 'configList',
        meta: {
          perms: [
            'POST /admin/goods/option/upload',
            'POST /admin/goods/option/delete',
            'POST /admin/goods/option/list',
            'POST /admin/goods/option/use',
            'POST /admin/goods/option/download',
            'POST /admin/goods/option/update',
            'POST /admin/goods/option/price/update'
          ],
          title: '产品配置',
          noCache: true
        }
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'adEdit',
        component: () => import('@/views/promotion/adEdit'),
        name: 'adEdit',
        meta: {
          perms: [
            'POST /admin/ad/create',
      ...
      },
      {
        ...
        meta: {
          perms: [
            ...
            'POST /admin/user/user/admin/update'
          ],
          title: '角色管理',
          noCache: true
        }
