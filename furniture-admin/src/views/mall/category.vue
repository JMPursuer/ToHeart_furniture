<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="类目图片" property="picUrl">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item v-if="dataForm.level ==='L1'" label="类目图标" prop="iconUrl">
          <el-upload
            :action="uploadPath"
            :headers="headers"
        ...
        <el-form-item v-if="dataForm.level ==='L2'" label="类目图片" prop="picUrl">
          <el-upload
            :action="uploadPath"
            :headers="headers"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm('此操作将删除此分类，是否确认?', '提示', {
