<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="商品ID" prop="gno" />
      <el-table-column align="center" label="商品编码" prop="goodsSn" />
      ...
      <el-table-column align="center" label="是否有库存" prop="isNew">
        <template slot-scope="scope">
          <el-tag :type="scope.row.isSpot ? 'success' : 'error'">{{
            scope.row.isSpot ? '有' : '无'
          }}</el-tag>
        </template>
      </el-table-column>
