...
import com.xinzhi.furniture.mall.admin.service.LogHelper;
import com.xinzhi.furniture.mall.admin.util.AdminResponseCode;
import com.xinzhi.furniture.mall.admin.util.Permission;
import com.xinzhi.furniture.mall.admin.util.PermissionUtil;
import com.xinzhi.furniture.mall.admin.vo.AuthReq;
...
import com.xinzhi.furniture.mall.db.service.LitemallPermissionService;
import com.xinzhi.furniture.mall.db.service.LitemallRoleService;
...
public class AdminAuthController {
     ...
     */
    @PostMapping("/login")
    public Object login(@RequestBody AuthReq req, HttpServletRequest request) {
    ...
    private Collection<String> toApi(Set<String> permissions) {
        if (systemPermissionsMap == null) {
            ...
            final String basicPackage = "com.xinzhi.furniture.mall.admin";
